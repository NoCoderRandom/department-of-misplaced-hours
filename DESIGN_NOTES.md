...
- The final exit prompt mirrors that route state: warrant routes name three mechanisms, while warrantless routes name only the file/hour mechanisms and explicitly mark the audit seal dark.
