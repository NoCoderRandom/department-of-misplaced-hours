...
- `scripts/smoke-release-archives.mjs` extracts both pending ZIP formats, serves the actual web roots, starts a new shift, and verifies touch-phone portrait orientation gating before release artifacts are promoted.
