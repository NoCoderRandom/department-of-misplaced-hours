...
- Late-game intercom guidance, the final exit prompt, Notes objectives, and wrong-item feedback mirror route state: warrant routes name the warrant option, while warrantless routes name only the file/hour mechanisms and explicitly mark the audit seal dark.
