...
- Dense puzzle panels use compact mobile button grids with a short-screen layout, and visual audit fails on hidden body text, overflowing button labels, ending-screen readability regressions, focus trap failures, or Escape regressions in normal and Large Text modes.
