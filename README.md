...
- Press `Escape` to close ordinary panels or put away the selected inventory item when no panel is open; the required Clock In orientation waits for its button.
